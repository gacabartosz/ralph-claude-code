...
# gemini, opencode, droid. Precedence: AGENT_PROVIDER env var > --provider flag > this file.
# Non-Claude providers need their CLI on PATH; see docs/providers/{CODEX,GEMINI,OPENCODE,DROID}.md.
